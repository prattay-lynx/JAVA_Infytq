...
class OfficeStaff extends Faculty{
    ...
    public double calculateSalary()
    {
        ...
        if(this.designation.equals("Accountant")) return totalSalary + 10000.0;
        else if(this.designation.equals("Clerk")) return totalSalary + 7000.0;
        else if(this.designation.equals("Peon")) return totalSalary + 4500.0;
...
class Teacher extends Faculty{
    ...
    {   
        double totalSalary = super.calculateSalary();
        if(this.qualification.equals("Doctoral")) return totalSalary + 20000.0;
        else if (this.qualification.equals("Masters")) return totalSalary + 18000.0;
        else if (this.qualification.equals("Bachelors")) return totalSalary + 15500.0;
        else if (this.qualification.equals("Associate")) return totalSalary + 10000.0;
        else return totalSalary;
    }
}


class MethodOverridingAssignment {
